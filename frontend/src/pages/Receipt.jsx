      ...
      <div style={styles.wrapper}>
        ...
        <div id="receipt-printable" ref={receiptRef} style={styles.receipt}>
          ...
          <div style={styles.metaGrid}>
            ...
            <div style={styles.metaItem}>
              <p style={styles.metaLabel}>Pick-up Slot</p>
              <p style={styles.metaValue}>{selectedSlot || order.pickupSlot}</p>
            </div>
            <div style={styles.metaItem}>
          ...
          <div style={styles.footer}>
            <p style={styles.footerText}>
              Please show this receipt at the library counter during your pick-up slot.
            </p>
            <p style={styles.footerText}>
